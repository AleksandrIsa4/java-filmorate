...
CREATE TABLE IF NOT EXISTS PUBLIC."friends" (
	...
	"friendship" boolean,
	CONSTRAINT "fk_Friends_FriendId" FOREIGN KEY ("friend_id") REFERENCES PUBLIC."user_kino"("user_id") ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT "fk_Friends_UserId" FOREIGN KEY ("user_id") REFERENCES PUBLIC."user_kino"("user_id") ON DELETE RESTRICT ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."genre_film" (
	...
	CONSTRAINT "fk_GenreFilm_FilmId" FOREIGN KEY ("film_id") REFERENCES PUBLIC."film"("film_id") ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE IF NOT EXISTS PUBLIC."like_users" (
	...
	"film_id" INTEGER NOT NULL,
	CONSTRAINT "fk_LikeUsers_FilmId" FOREIGN KEY ("film_id") REFERENCES PUBLIC."film"("film_id") ON DELETE RESTRICT ON UPDATE RESTRICT,
	CONSTRAINT "fk_LikeUsers_UserId" FOREIGN KEY ("user_id") REFERENCES PUBLIC."user_kino"("user_id") ON DELETE RESTRICT ON UPDATE RESTRICT
);
