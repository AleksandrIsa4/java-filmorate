...
MERGE INTO PUBLIC."event" KEY (id) VALUES (1, 'LIKE');
MERGE INTO PUBLIC."event" KEY (id) VALUES (2, 'REVIEW');
MERGE INTO PUBLIC."event" KEY (id) VALUES (3, 'FRIEND');
...
MERGE INTO PUBLIC."operation" KEY (id) VALUES (1, 'ADD');
MERGE INTO PUBLIC."operation" KEY (id) VALUES (2, 'UPDATE');
MERGE INTO PUBLIC."operation" KEY (id) VALUES (3, 'REMOVE');
